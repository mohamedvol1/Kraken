...
const Header = () => {
	...
	return (
		<header className="bg-black fixed top-0 w-full h-26  z-10">
			<SpecialOffers />
			{/* <!-- navbar container --> */}
			<div className="w-full sm:w-9/12 px-1 pt-5 sm:px-4 m-auto flex justify-between items-center relative">
				{/* <!-- logo & search container --> */}
				<div className="flex items-center flex-1 h-full">
        <div className="w-24 h-24 mr-1 sm:mr-4">
          <Link className="h-7" to="/">
            <img
              draggable="false"
